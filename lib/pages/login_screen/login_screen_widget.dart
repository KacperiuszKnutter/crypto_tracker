                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          // gesture detector, żeby reagował na kliknięcie:
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 24.0),
                                  child: Text(
                                    'Podaj email oraz hasło by rozpocząć',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Plus Jakarta Sans',
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      // szyukamy użytkownika w bazie danych
                                      final success = await DatabaseService().loginUser(email, password);

                                      if (success) {
                                        // jeśli znaleziono użytkownika to wysyłamy dane do auth managera
                                        await authManager.signIn(
                                          authenticationToken: 'local_token',
                                          authUid: email,
                                        );
